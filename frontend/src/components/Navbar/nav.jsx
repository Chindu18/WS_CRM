  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="relative w-10 h-10 flex items-center justify-center rounded-xl text-gray-600 hover:bg-gray-50 transition-colors"
...
/* ----------------------- Profile Menu ----------------------- */
function ProfileMenu({ userName, userRole, onLogout, profilePath = "/profile" }) {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      >
        <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-blue-600 flex itemss items-center justify-center">
    ...
    <header className="w-full bg-white border-b border-gray-200 sticky top-0 z-30">
      <div className="px-3 sm:px-4 md:px-0 py-3">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 md:gap-4">
          {/* Left */}
          <div className="flex items-center justify-between md:justify-start min-w-0 pl-4 md:pl-6">
            <div className="flex items-center">
              {/* Gap between toggle and logo */}
              <div
                className={`${
                  showSidebarToggle ? "ml-10" : "ml-0"
          ...
          {/* Search */}
          <div className="w-full md:flex-1 md:flex md:justify-center min-w-0">
            <div className="relative w-full md:max-w-3xl">
              ...
              <input
                ...
                className="
                  ...
                  border border-gray-200 bg-gray-50 text-sm outline-none
          ...
          {/* Desktop right */}
          <div className="hidden md:flex items-center gap-4 min-w-[220px] justify-end md:pr-6">
            <NotificationMenu initialNotifications={initialNotifications} />
            <ProfileMenu
              userName={user.name}
              userRole={user.role}
