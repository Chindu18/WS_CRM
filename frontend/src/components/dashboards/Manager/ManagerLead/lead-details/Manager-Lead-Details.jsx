...
// ✅ IMPORTANT: match your real path + filename case
...
export default function ManagerLeadDetail({ leadId, onNavigate, userRole }) {
  ...
  const handleUpdateLead = (updatedLeadData, isEdit = false) => {
    ...
    openPopup(
      "success",
      isEdit ? "Lead Updated" : "Lead Added",
      isEdit
  ...
  const handleCallSubmit = (callData) => {
    ...
    openPopup("success", "Call Logged", "Call details saved successfully.");
  };
    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-6 lg:p-8">
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="rounded-xl border border-gray-200 bg-white">
              <div className="border-b border-gray-200">
                <div className="flex overflow-x-auto">
                  {["overview", "activity", "notes", "payment"].map((tab) => (
                    <button
                      key={tab}
              ...
              <div className="p-4 md:p-6">
                ...
                {activeTab === "activity" && <LeadActivity />}

                {activeTab === "notes" && (
                  <LeadNotes lead={lead} openPopup={openPopup} />
                )}

                {activeTab === "payment" && (
                  <Leadpayments openPopup={openPopup} />
                )}
              </div>
            </div>
          </div>
          ...
          {/* Right Column */}
          <FollowUpScheduler openPopup={openPopup} />
        </div>
      </div>
