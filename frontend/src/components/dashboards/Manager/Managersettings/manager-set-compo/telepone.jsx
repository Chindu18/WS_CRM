...
export default function TelephonyTab({ openPopup }) {
  ...
  // ✅ Local popup fallback if openPopup not passed
  ...
  const handleAddNumber = () => {
    ...
    try {
      ...
      safePopup(
        "success",
        "Number Added!",
        `Phone number ${newPhone.number} added successfully.`
      );
    } catch (err) {
      console.error(err);
      safePopup(
        "failure",
        "Add Failed",
        "Could not add phone number. Try again."
      );
    }
  };
  ...
  const handleSaveEdit = () => {
    ...
    try {
      ...
      safePopup(
        "success",
        "Number Updated!",
        `Phone number ${formData.number} updated successfully.`
      );
      ...
      safePopup(
        "failure",
        "Update Failed",
        "Could not update phone number. Try again."
      );
    }
  };
  ...
  return (
    <>
      {/* ✅ Local popup (only if global not passed) */}
      {!openPopup && (
        <Popup
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-600 mt-2">
              Manage phone numbers and call configurations
            </p>
          </div>
          <button
                  ...
                  >
                    ...
                    <td className="py-4 px-6">
                      {editingPhone?.id === phone.id ? (
                        ...
                        <span
                          className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${getTypeBadgeStyle(
                            phone.type
                          )}`}
                        >
                          {phone.type}
            ...
            {[
              {
                ...
                description:
                  "Automatically record all calls for quality and training purposes",
                state: callRecording,
              ...
              },
              {
                ...
                description:
                  "Intelligently detect and skip voicemails to optimize calling time",
              ...
              },
              {
                ...
                description:
                  "Notify team members about missed calls and important call events",
