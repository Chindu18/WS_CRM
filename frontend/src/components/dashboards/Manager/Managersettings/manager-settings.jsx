...
import UsersRolesTab from './manager-set-compo/user-Role';
import IntegrationsTab from './manager-set-compo/integrationTab/integrationTab'
import TelephonyTab from './manager-set-compo/telepone';
import EmailTemplatesTab from './manager-set-compo/emailTemplatesTab/emailTemplatesTab';
