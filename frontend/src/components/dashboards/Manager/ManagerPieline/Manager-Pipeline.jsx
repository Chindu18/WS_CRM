...
//     return [
//       { id: 1, title: "Total Pipeline Value", value: formatCurrency(totalPipelineValue) },
...
//     setColumns(
//       columns.map((col) => {
//         if (col.id === draggedFromColumn) return { ...col, leads: sourceLeads };
//         if (col.id === targetColumnId) return { ...col, leads: targetLeads };
//         return col;
//       })
//     );
...
//     notify("success", "Deal deleted successfully 🗑️");
//   };
...
//     if (newDeal.name.trim().length < 3) errors.name = "Name must be at least 3 characters";
//     else success.name = "Looks good ✔";

//     if (!newDeal.company.trim()) errors.company = "Company is required";
//     else success.company = "Looks good ✔";

//     if (!newDeal.value || Number(newDeal.value) <= 0) errors.value = "Value must be greater than 0";
//     else success.value = "Valid value ✔";

//     if (!/^[0-9]{10}$/.test(newDeal.phone)) errors.phone = "Phone must be 10 digits";
...
//     console.log("🎯 New Deal Added:", finalLead);
