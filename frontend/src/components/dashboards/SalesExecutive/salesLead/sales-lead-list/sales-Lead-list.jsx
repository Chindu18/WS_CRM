...
import LeadForm from '../sales-lead-compo/add-Lead-form';
import SalesEmailModal from '../sales-lead-compo/lead-mail';
import SalesWhatsAppModal from '../sales-lead-compo/lead-whatsup';
...
// Main Component
export default function TeamLeadsList({ onNavigate, userRole = 'admin' }) {
  ...
  // Function to handle lead name click
  const handleLeadClick = (lead) => {
    // Navigate to lead detail page with the lead data
    navigate(`/salesexecutive/lead-details/${lead.id}`, {
      state: { 
        lead,
        fromTeamLeadsList: true 
      }
    });
  };
