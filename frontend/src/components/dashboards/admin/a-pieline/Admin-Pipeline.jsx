...
//   return (
//     <div className="w-full min-w-0 overflow-x-hidden space-y-6 p-4 sm:p-6">
//       {/* ✅ POPUP */}
//       <Popup
//         open={popup.open}
//         type={popup.type}
...
//           <div
//             key={item.id}
//             className="rounded-xl border border-gray-200 shadow-sm bg-white min-w-0"
//           >
...
//                   type="button"
//                   onClick={() => setShowAddDealModal(false)}
//                   className="px-4 py-2 border border-gray-300 hover:bg-gray-100 rounded-lg font-semibold flex items-center gap-2"
//                 >
//                   <X className="w-4 h-4" />
//                   Cancel
//                 </button>
//                 <button
//                   type="submit"
//                   className="bg-black text-white px-4 py-2 hover:bg-gray-800 rounded-lg font-semibold flex items-center gap-2"
//                 >
