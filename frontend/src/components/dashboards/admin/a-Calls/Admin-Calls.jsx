...
const StatCard = ({ title, value, icon: Icon, iconBg, iconColor }) => (
  <div className="bg-white border border-gray-200 rounded-xl p-4 sm:p-6 min-w-0">
    <div className="flex items-center justify-between gap-3">
      ...
      <div
        className={`w-10 h-10 sm:w-12 sm:h-12 ${iconBg} ${iconColor} rounded-xl flex items-center justify-center flex-shrink-0`}
      >
...
const FilterSelect = ({ value, onChange, options, placeholder }) => (
  <div className="relative flex-1 min-w-[140px] sm:min-w-[180px] sm:max-w-[220px]">
    <select
      value={value}
      onChange={onChange}
...
export function AdminCallPage() {
  ...
  return (
    ...
    <div className="w-full min-w-0 bg-gray-50 overflow-x-hidden">
      {/* EXPORT AREA */}
      <div
        ref={printableRef}
      ...
      >
        ...
        {/* ✅ Desktop Table */}
        <div className="hidden md:block bg-white border border-gray-200 rounded-xl overflow-hidden w-full">
          ...
          {filteredCalls.map((call) => (
            ...
            >
              <div className="flex justify-between items-start gap-2">
                ...
                <button
                  onClick={() => handleMakeCall(call)}
                  className="inline-flex items-center justify-center w-9 h-9 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors flex-shrink-0"
                >
                  <Phone className="w-4 h-4" />
                </button>
              </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-4 sm:p-6 w-full">
          ...
          {/* ✅ fixed recharts container size */}
          <div className="w-full max-w-3xl mx-auto h-72 sm:h-80 min-h-[280px]">
