...
export default function TlGeneratePaymentLinkModal({ isOpen, onClose, lead }) {
  ...
  const validateForm = () => {
    ...
    if (Object.keys(newErrors).length > 0) {
      openPopup(
        "failure",
        "Validation Error",
        "Please fix the highlighted fields before generating a link."
      );
      return false;
    }
  ...
  const handleSubmit = async () => {
    ...
    // ✅ waiting popup
    openPopup("waiting", "Please wait...", "Generating payment link...");
    ...
    openPopup(
      ...
      `A payment link for ₹${Number(amount).toLocaleString()} was created successfully.`
    );
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-green-100 text-sm mt-1">
                    Create secure payment link for {lead?.name}
                  </p>
                </div>
              </div>
              <button 
              ...
              {expandedSections.purpose && (
                <div className="p-4">
                  <input
                    ...
                    placeholder="e.g., Premium package subscription, Initial deposit..."
                    value={purpose}
                    onChange={(e) => {
