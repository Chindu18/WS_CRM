...
const LeadForm = ({
  ...
  const validateForm = () => {
    ...
    if (Object.keys(newErrors).length > 0) {
      notify("failure", "Please fix the highlighted errors before submitting.");
    }
  ...
  const handleSubmit = async (e) => {
    ...
    notify("waiting", editLead ? "Updating lead..." : "Saving lead...");
    ...
    // optional close after save if you want:
    // onClose();
  };
