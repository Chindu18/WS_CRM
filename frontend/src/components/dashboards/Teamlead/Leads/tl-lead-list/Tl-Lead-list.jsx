...
import LeadForm from '../tl-lead-components/add-Lead-form';
import EmailModal from '../tl-lead-components/lead-mail';
import WhatsAppModal from '../tl-lead-components/lead-whatsup';
...
export default function TeamLeadsList({ onNavigate, userRole = 'admin' }) {
  ...
  const handleLeadClick = (lead) => {
    ...
    navigate(`/teamlead/lead-details/${lead.id}`, {
      state: { 
        lead,
