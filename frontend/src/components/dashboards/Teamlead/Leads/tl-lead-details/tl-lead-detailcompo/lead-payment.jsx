...
export default function TlLeadPayments() {
  ...
  const handlePaymentSubmit = (e) => {
    ...
    if (validatePaymentForm()) {
      ...
      showPopup("success", "Payment information saved successfully!");
      // if you later do API call, you can show waiting first:
      // showPopup("waiting", "Saving payment info...");
    } else {
      showPopup("failure", "Please fix the form errors before submitting.");
    }
  };
  ...
  const handleCopyPaymentLink = () => {
    navigator.clipboard
      ...
      .then(() => {
        showPopup("success", "Payment link copied to clipboard!");
      })
      .catch((err) => {
        console.error("Failed to copy: ", err);
        showPopup("failure", "Failed to copy payment link");
      });
  };

  return (
    <>
      {/* ✅ Popup instead of Toastify */}
      {popup.open && (
        <Popup
          type={popup.type}
        ...
        <div className="flex gap-3 pt-2">
          ...
          <button
            ...
            onClick={() => {
              ...
              setPaymentErrors({});
              showPopup("success", "Form cleared");
            }}
