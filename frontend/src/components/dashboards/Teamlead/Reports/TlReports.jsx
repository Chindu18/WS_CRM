...
export function TeamLeadReportsModule({ userRole = "viewer" }) {
  ...
  return (
    ...
    <div className="w-full overflow-x-hidden bg-gray-50">
      <div
        ref={printableRef}
        className="space-y-6 p-3 sm:p-6 max-w-7xl mx-auto min-w-0"
      >
        {/* Header */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          {/* Export (kept same UI, just responsive container) */}
          {canExportData && (
            <div className="w-full sm:w-auto">
              <ExportButton
                targetRef={printableRef}
                fileName="payments-dashboard.pdf"
              >
          ...
          {[
            ...
            <button
              ...
              className={[
                ...
                "flex-1 sm:flex-none", // ✅ fill width on mobile, compact on desktop
                i === 0 ? "rounded-l-xl" : "",
        ...
        {selectedTab === "leads" && (
          <div className="space-y-6 min-w-0">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 min-w-0">
              {/* Funnel Horizontal (chart untouched) */}
            ...
            {/* Conversion Trend Line (chart untouched) */}
            <div className="bg-white border border-gray-200 rounded-xl p-4 sm:p-6 min-w-0">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">
            ...
            {[
              ...
              >
                <div className="flex items-center justify-between gap-3">
                  ...
                  <div
                    className={`w-10 h-10 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center shrink-0 ${badge}`}
                  >
...
export default TeamLeadReportsModule;
